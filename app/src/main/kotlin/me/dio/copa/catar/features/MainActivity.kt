...
class MainActivity : ComponentActivity() {
    ...
    private fun observeActions() {
        viewModel.action.observe(this) { action ->
            when (action) {
                is MainUiAction.MatchesNotFound -> NotificationMatcherWorker.startMatchesNotFound(applicationContext)
                MainUiAction.Unexpected -> NotificationMatcherWorker.startUnexpected(applicationContext)
